...
- 2026-02-25T16:13:07+00:00: Completed `deactivate-06` by updating `DevVenuesPage` to show venue active/inactive status, add Deactivate/Reactivate action buttons (with deactivate confirmation), hide Tythe deactivate in the UI, and refresh the list after actions. Verified `./ralph/verify-tt-dev-venue-deactivate-20260225.sh` passes (7/7).
