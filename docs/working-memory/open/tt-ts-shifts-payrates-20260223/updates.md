...
- 2026-02-23: Completed `payrates-01` in `tt-ts/src/client/pages/ManagerPage.tsx` by adding per-user "Pay rates" expanders in Manage Users with Standard/Enhanced/Supervisor £/hr number inputs, validation, save state/messages, and `users.setPayRates(...)` integration.
