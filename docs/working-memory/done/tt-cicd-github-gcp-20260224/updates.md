# Updates: tt-cicd-github-gcp-20260224
...
- 2026-02-24: **Pivoted** — GitHub Actions workflow removed (OIDC/permission issues). Using Cloud Run "Deploy from repository" UI instead. See `docs/CICD_SETUP.md`.
