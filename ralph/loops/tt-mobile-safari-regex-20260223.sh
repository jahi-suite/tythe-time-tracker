...
# Ralph loop for: tt-mobile-safari-regex-20260223
# Fix mobile Safari regex crash (SyntaxError: invalid group specifier name)

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
REPO_ROOT="$(cd "$SCRIPT_DIR/../.." && pwd)"
. "$REPO_ROOT/ralph/lib.sh"

TASK_ID="tt-mobile-safari-regex-20260223"
