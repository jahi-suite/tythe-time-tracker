...
# Ralph loop for: tt-marketing-page-v2-20260224
...
TASK_ID="tt-marketing-page-v2-20260224"
...
verify() {
  "$REPO_ROOT/ralph/verify-tt-marketing-page-v2-20260224.sh"
}
...
info "Full RALPH rewrite: Constance hero, late-night aesthetic, outcome-first..."
ITERATION=0
while [ $ITERATION -lt $MAX_ITERATIONS ]; do
  ITERATION=$((ITERATION + 1))
  if verify; then
    ok "Marketing page v2 complete at iteration $ITERATION"
    exit 0
  fi
