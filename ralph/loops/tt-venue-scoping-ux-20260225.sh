...
# Ralph loop for: tt-venue-scoping-ux-20260225
...
TASK_ID="tt-venue-scoping-ux-20260225"
...
verify() {
  "$REPO_ROOT/ralph/verify-tt-venue-scoping-ux-20260225.sh"
}
...
while [ $ITERATION -lt $MAX_ITERATIONS ]; do
  ...
  if verify; then
    ok "Venue scoping UX complete at iteration $ITERATION"
    exit 0
  fi
