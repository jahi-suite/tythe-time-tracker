...
# Ralph loop for: tt-dev-venue-deactivate-20260225
...
TASK_ID="tt-dev-venue-deactivate-20260225"
...
verify() {
  "$REPO_ROOT/ralph/verify-tt-dev-venue-deactivate-20260225.sh"
}
...
while [ $ITERATION -lt $MAX_ITERATIONS ]; do
  ...
  if verify; then
    ok "Dev venue deactivate complete at iteration $ITERATION"
    exit 0
  fi
